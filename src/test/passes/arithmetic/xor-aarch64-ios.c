...
// R3-NEXT:     	ldr	w9, [sp, #8]
// R3-NEXT:     	ldrsb	w11, [x8, x9]
// R3-NEXT:     	str	w11, [sp, #4]
// R3-NEXT:     	mov	w12, #35
// R3-NEXT:     	and	w8, w11, w12
// R3-NEXT:     	orr	w9, w11, w12
// R3-NEXT:     	add	w8, w8, w9
// R3-NEXT:     	add	w8, w8, #2
// R3-NEXT:     	subs	w9, w8, #1
// R3-NEXT:     	mov	w10, #-1
// R3-NEXT:     	orr	w8, w11, w10
// R3-NEXT:     	and	w10, w11, w10
// R3-NEXT:     	subs	w10, w8, w10
// R3-NEXT:     	mov	w8, #-36
// R3-NEXT:     	lsl	w8, w8, #1
// R3-NEXT:     	add	w13, w8, #36
// R3-NEXT:     	eor	w8, w10, w13
// R3-NEXT:     	and	w10, w10, w13
// R3-NEXT:     	add	w10, w8, w10
...
// R3-NEXT:     	orr	w9, w11, w12
// R3-NEXT:     	add	w8, w8, w9
// R3-NEXT:     	eor	w9, w11, w12
// R3-NEXT:     	and	w11, w11, w12
// R3-NEXT:     	add	w9, w9, w11
// R3-NEXT:     	mvn	w9, w9
// R3-NEXT:     	add	w8, w8, w9
// R3-NEXT:     	add	w8, w8, #1
// R3-NEXT:     	mvn	w9, w8
// R3-NEXT:     	add	w9, w9, #0
// R3-NEXT:     	add	w11, w9, #1
// R3-NEXT:     	orr	w9, w10, w11
// R3-NEXT:     	and	w11, w10, w11
// R3-NEXT:     	subs	w9, w9, w11
// R3-NEXT:     	mvn	w8, w8
// R3-NEXT:     	add	w8, w8, #0
// R3-NEXT:     	add	w8, w8, #1
// R3-NEXT:     	orn	w8, w8, w10
// R3-NEXT:     	mvn	w10, w10
