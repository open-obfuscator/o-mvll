...
define { i64, ptr, i1, ptr } @test_function() {
  %1 = call swiftcc { i64, ptr, i1, ptr } @"foo"(i64 -3458764513820540911, ptr inttoptr (i64 or (i64 sub (i64 ptrtoint ([13 x i8]* @.str.4 to i64), i64 32), i64 -9223372036854775808) to ptr))
