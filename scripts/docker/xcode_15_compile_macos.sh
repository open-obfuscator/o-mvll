...
cp ../tmp/third-party-xcode15/omvll-deps-xcode-*/LLVM-16.0.0git-arm64-Darwin.tar.gz .
cp ../tmp/third-party-xcode15/omvll-deps-xcode-*/LLVM-16.0.0git-x86_64-Darwin.tar.gz .
cp ../tmp/third-party-xcode15/omvll-deps-xcode-*/Python-slim.tar.gz .
cp ../tmp/third-party-xcode15/omvll-deps-xcode-*/pybind11.tar.gz .
cp ../tmp/third-party-xcode15/omvll-deps-xcode-*/spdlog-1.10.0-Darwin.tar.gz .
...
cmake -GNinja ../.. \
      ...
      -DCMAKE_CXX_COMPILER=${DEPS_FOLDER}/LLVM-16.0.0git-arm64-Darwin/bin/clang++ \
      -DCMAKE_C_COMPILER=${DEPS_FOLDER}/LLVM-16.0.0git-arm64-Darwin/bin/clang \
      ...
      -DLLVM_DIR=${DEPS_FOLDER}/LLVM-16.0.0git-arm64-Darwin/lib/cmake/llvm \
...
cmake -GNinja ../.. \
      ...
      -DCMAKE_OSX_DEPLOYMENT_TARGET="14.5" \
      -DCMAKE_CXX_COMPILER=${DEPS_FOLDER}/LLVM-16.0.0git-x86_64-Darwin/bin/clang++ \
      -DCMAKE_C_COMPILER=${DEPS_FOLDER}/LLVM-16.0.0git-x86_64-Darwin/bin/clang \
      -DCMAKE_BUILD_TYPE=Release \
      -DPYBIND11_NOPYTHON=1 \
      -DPython3_ROOT_DIR=${DEPS_FOLDER} \
      -DPython3_LIBRARY=${DEPS_FOLDER}/lib/libpython3.10.a \
      ...
      -Dpybind11_DIR=${DEPS_FOLDER}/share/cmake/pybind11 \
      -Dspdlog_DIR=${DEPS_FOLDER}/lib/cmake/spdlog \
      -DLLVM_DIR=${DEPS_FOLDER}/LLVM-16.0.0git-x86_64-Darwin/lib/cmake/llvm \
      -DLLVM_TOOLS_DIR=${OMVLL_LLVM_TOOLS_DIR} \
      -DLLVM_EXTERNAL_LIT=${OMVLL_LLVM_TOOLS_DIR}/bin/llvm-lit
